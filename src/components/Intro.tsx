  ...
  return (
    <main class="w-full flex flex-col items-stretch justify-start">
      <section class="relative h-72">
        ...
        <div class="grill-background before:bg-slate-700 dark:before:bg-slate-400 before:bg-opacity-30 before:rotate-1 w-full h-full">
          <div class="py-8 px-12 lg:mx-auto h-full w-full max-w-[96rem] flex flex-col items-start justify-end gap-2">
            <p
            ...
            <a
              ...
              bg-white hover:bg-gray-800 text-gray-800 hover:text-white border-gray-800
              dark:bg-gray-800 dark:hover:bg-white dark:text-white dark:hover:text-gray-800 dark:border-white"
              href="/about"
            >
              더 알아보기
            </a>
